...
#+SUBTITLE: for version 1.1.0 (v1.1.0-28-g6726802+1)
...
#+TEXINFO: @noindent
This manual is for Org-roam version 1.1.0 (v1.1.0-28-g6726802+1).
...
By default, links are inserted with the title as the link description. This can
make them hard to distinguish from external links. You may choose add special
indicators for Org-roam links by tweaking =org-roam-link-title-format=, for
example:
